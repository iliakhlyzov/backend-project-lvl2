...
const diffJson = readFileSync(getPathToFile('__fixtures__/diff.json'), 'utf-8');
...
test('json format', () => {
  expect(genDiff('__fixtures__/before.yml', '__fixtures__/after.json', 'json')).toEqual(diffJson);
});
